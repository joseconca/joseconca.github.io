        ...
        <div className="flex flex-col md:flex-row border-b border-[#e0e0e0]">
          ...
          <div className="md:w-1/2 px-[30px] py-[20px] hover:bg-[#f2f2f2] transition-colors">
            ...
            <ul className="list-none font-mono bg-[#40516a] text-[#ecf0f1] border-[3px] border-[#2c3e50] rounded-sm p-2.5 mb-2.5 hover:shadow-[0_2px_8px_rgba(0,0,0,0.3)] transition-shadow">
              <li className="mb-1">
                <strong>Lenguajes:</strong> {skillStack.lenguajes.tecnologias.join(", ")}
              </li>
              <li className="mb-1">
                <strong>Backend & DB:</strong> {skillStack.backend.tecnologias.join(", ")}
              </li>
              <li className="mb-1">
                <strong>Frontend:</strong> {skillStack.frontend.tecnologias.join(", ")}
              </li>
              <li className="mb-1">
                <strong>DevOps & Cloud:</strong> {skillStack.devopsCloud.tecnologias.join(", ")}
              </li>
              <li className="mb-1">
                <strong>Otros:</strong> {skillStack.otros.tecnologias.join(", ")}
              </li>
            </ul>
          </div>
        </div>
