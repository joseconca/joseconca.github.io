export const skillStack = {
  ...
  devopsCloud: {
    descripcion: "Herramientas para controlar versiones, contenerizar y desplegar aplicaciones.",
    tecnologias: ["Git", "Docker", "Azure"],
  },
  otros: {
    descripcion: "Herramientas y prácticas complementarias para el desarrollo y la calidad del software.",
    tecnologias: ["REST APIs", "Postman", "Cypress"],
  },
};
